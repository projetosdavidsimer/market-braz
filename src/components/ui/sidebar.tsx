...
function SidebarProvider({
  ...
  // Render stable version during SSR and client
  return (
    <SidebarContext.Provider value={contextValue} suppressHydrationWarning>
      <TooltipProvider delayDuration={0} suppressHydrationWarning>
        <div
